...
<html lang="en">
  <head>
    <title>Bright Purple Resourcing - Vacancies</title>
    <meta charset="utf-8">
	...
	<!-- Linking the current page with the common.php file to allow the generation of vacancies -->
  ...
  <div class="site-wrap">
	...
	<!-- Calling the generateVacancies function from common.php in order to generate the vacancies -->
      <?php generateVacancies(); ?>
